...
func FromBytes(data []byte, opts ...TokenizerOption) (*Tokenizer, error) {
	...
	fromBytesFn := (*[0]byte)(fromBytesFunc)
	tokenizer := unsafe.Pointer(uintptr((*(*func(data *byte, len C.uint, opts *tokenizerOpts) unsafe.Pointer)(unsafe.Pointer(&fromBytesFn)))(
